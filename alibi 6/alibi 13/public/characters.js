...
export function characterParts(config={}){
 ...
 return {a,ink,paper,outfit,heads,poses,glasses,hair,hats};
}
export function characterSvg(config={}, {crown=false,faceOnly=false}={}){
 const {a,ink,paper,outfit,heads,poses,glasses,hair,hats}=characterParts(config);
